...
export default function Projects() {
  ...
  return (
    <main style={{ marginBottom: "10%" }} className={inter.className}>
      <NavBar />
      ...
      <div style={{ marginLeft: "10%", marginRight: "10%" }}>
        ...
        >
          <div style={{ fontSize: "400%" }} className={outer.className}>
            Projects
          </div>
        </div>
      ...
      /> */}
        ...
        <div style={{ marginTop: "2%" }}>
          {PosImages.map((e) => {
            return (
              <div style={{ textAlign: "center" ,position:'relative',width:'100%',aspectRatio:70/45}}>
                <Image
                  style={{ margin: "1%" }}
                fill
                  src={"/" + e.img}
        ...
        <div >
          <div style={{ fontSize: "200%", color: "#0097e8",padding:'2%' }}>
          ...
          <div style={{ fontSize: "120%", marginTop: "1%", color: "#666666" ,padding:'2%' }}>
            Verve POS App help businesses track and manage their product
          ...
          <div style={{ fontSize: "120%", marginTop: "1%", color: "#666666",padding:'2%'  }}>
            ...
            descriptions, prices, and images. It simplifies the process of
          ...
          <div style={{ fontSize: "120%", marginTop: "1%", color: "#666666",padding:'2%'  }}>
            ...
            barcode. Verve POS apps offer barcode scanning functionality,
            enabling users to quickly add products to the inventory by scanning
            their barcodes.
          </div>
          ...
          <div style={{ fontSize: "120%", marginTop: "1%", color: "#666666",padding:'2%'  }}>
            ...
            labels for products, pricing, and barcodes directly from the app.
            This feature is especially useful for retail stores and businesses
            that need to label items for inventory tracking, pricing, and
